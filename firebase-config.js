      ...
      <section class="panel board-panel">
        ...
        <section class="daily-record-panel">
          <div class="record-head">
            <div>
              <h3>บันทึกผลงานวันนี้</h3>
              <p id="recordDateLabel" class="muted small">อัปเดตตามวันที่วันนี้</p>
            </div>
            <p class="muted small">นับจากเวลาออเดอร์เข้าบอร์ด จนถึงเวลาที่กดเสร็จหรือทำครบทุกเมนู</p>
          </div>
          <div class="record-grid">
            <div class="record-card">
              <span>ออเดอร์วันนี้</span>
              <strong id="dailyTotalCount">0</strong>
            </div>
            <div class="record-card is-good">
              <span>เสร็จ ≤ 15 นาที</span>
              <strong id="dailyWithin15Count">0</strong>
            </div>
            <div class="record-card is-warn">
              <span>15–25 นาที</span>
              <strong id="daily15to25Count">0</strong>
            </div>
            <div class="record-card is-orange">
              <span>25–30 นาที</span>
              <strong id="daily25to30Count">0</strong>
            </div>
            <div class="record-card is-danger">
              <span>เกิน 30 นาที</span>
              <strong id="dailyOver30Count">0</strong>
            </div>
            <div class="record-card is-accent">
              <span>เสร็จสิ้นทั้งหมด</span>
              <strong id="dailyCompletedCount">0</strong>
            </div>
          </div>
        </section>
