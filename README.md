...
- OCR อ่านข้อความจากรูปด้วย Tesseract.js (ไทย + อังกฤษ)
- สร้างรายการอาหารจากข้อความที่อ่านได้อัตโนมัติ
...
### ฝั่ง Hostess
1. กรอกเลขบิล หรือโต๊ะ/ห้อง
2. ถ่ายรูปออเดอร์
3. ถ้าต้องการ สามารถพิมพ์ข้อความ OCR เองก่อนส่งได้
...
### เรื่อง “คำอ่าน”
ในเวอร์ชันนี้ ช่อง “คำอ่าน / ข้อความแก้ไขเพิ่มเติม” จะถูกเติมจากข้อความ OCR ก่อน และสามารถแก้ไขเองได้

ถ้าต้องการ “คำอ่านภาษาไทยของชื่ออาหารภาษาอังกฤษแบบแม่นยำ” จริง ๆ ควรต่อ API เพิ่มภายหลัง เช่น Cloud Function / AI API สำหรับแปลงคำอ่านเฉพาะเมนูของร้าน
